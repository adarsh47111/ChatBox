    ...
    <>
      <div className="p-4 space-y-5">
        ...
        <div className="flex justify-between items-center px-2">
          ...
          <div className="flex justify-center items-center h-8 w-8 rounded-full hover:bg-muted-foreground hover:opacity-20 cursor-pointer">
            <GroupDialogBox>
              <Plus color="#878787" size={25} />
            </GroupDialogBox>
          </div>
        </div>
  ...
  return (
    <>
      <div
        ...
        onClick={() => {
          dispatch(
            SelectConversation({ chat_type: "GROUP_CHAT", room_id: room_id })
          );
        }}
      >
        <Avatar>
        ...
        <div className="flex justify-between h-[60%] w-full">
          ...
          >
            ...
            <p className="text-sm">{latest_message?.text}</p>
          </div>
          {latest_message ? (
